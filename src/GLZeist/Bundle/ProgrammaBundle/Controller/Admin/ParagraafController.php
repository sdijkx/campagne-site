...
{
    /**
     * Lists all Paragraaf entities.
     *
     * @Route("/", name="paragraaf")
     * @Template()
     */
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GLZeistProgrammaBundle:Paragraaf')->findAll();
     ...
     *
     * @Route("/create", name="paragraaf_create")
     * @Method("POST")
     ...
     *
     * @Route("/{id}/edit", name="paragraaf_edit")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/update", name="paragraaf_update")
     * @Method("POST")
     ...
     *
     * @Route("/{id}/delete", name="paragraaf_delete")
     * @Method("POST")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('paragraaf'));
    }
